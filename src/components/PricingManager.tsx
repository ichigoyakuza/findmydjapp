  ...
  const [priceRules, setPriceRules] = useState<PriceRule[]>([
    {
      ...
      basePrice: 1.99,
      currency: 'EUR',
      description: 'Prix standard pour un single'
    },
    {
      id: '2',
      name: 'Remix Premium',
      ...
      basePrice: 2.99,
      currency: 'EUR',
      description: 'Prix pour les remixes exclusifs'
    }
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-dark-800 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-white">Règles de Prix</h3>
          <button
      ...
      {/* Prix par Track */}
      <div className="bg-dark-800 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-white mb-4">Prix par Musique</h3>
        <div className="space-y-3">
          {trackPricing.map((tp) => (
            <div key={tp.trackId} className="bg-dark-700 rounded-lg p-4 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Prix actuel: {tp.currentPrice.toFixed(2)} EUR</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <select
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-dark-800 rounded-xl p-6">
          <h4 className="text-white font-medium mb-2">Prix Moyen</h4>
        ...
        <div className="bg-dark-800 rounded-xl p-6">
          <h4 className="text-white font-medium mb-2">Revenus Estimés</h4>
          <p className="text-2xl font-bold text-green-400">
            {(trackPricing.reduce((sum, tp) => sum + tp.currentPrice, 0) * 0.98).toFixed(2)} EUR
          </p>
          <p className="text-gray-400 text-sm">Après commission 2%</p>
        </div>
        <div className="bg-dark-800 rounded-xl p-6">
          <h4 className="text-white font-medium mb-2">Musiques Configurées</h4>
